    ...
    <div className="-mx-4 flex flex-wrap">
      <div className="w-full px-4">
        <div className="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
          ...
          >
            We got you <a className="text-red-600">Covered</a>
          </h2>
          <p className="text-body-color text-base">
            Custom Websites lets you stand out, if you currently have a website we also have options to help you update regardless the technology. 
          </p>
        </div>
      </div>
    </div>
    <div className="-mx-4 flex flex-wrap justify-center">
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        ...
        >
          ...
          <p
            className="text-body-color font-bold text-red-600 mb-8 border-b border-[#F2F2F2] pb-8 text-base"
          >
            Create website using a theme
          </p>
          <div className="mb-7">
            <p className="text-body-color mb-1 text-base leading-loose">1 User</p>
      ...
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        ...
        >
          ...
          <p
            className="text-body-color font-bold  text-red-600 mb-8 border-b border-[#F2F2F2] pb-8 text-base"
          >
            Create website using custom design
          </p>
          <div className="mb-7">
            <p className="text-body-color mb-1 text-base leading-loose">5 Users</p>
            <p className="text-body-color mb-1 text-base leading-loose">
             All of Silver
            </p>
            <p className="text-body-color mb-1 text-base leading-loose">
          ...
          <a
            href="/contact"
            className="bg-primary border-primary block w-full rounded-md border p-4 text-center text-base font-semibold hover:bg-opacity-90"
          >
            Contact Us
          </a>
          <div>
      ...
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        ...
        >
          ...
          <p
            className="text-body-color font-bold text-red-600 mb-8 border-b border-[#F2F2F2] pb-8 text-base"
          >
           Enterprise level custom designed website
          </p>
          <div className="mb-7">
            <p className="text-body-color mb-1 text-base leading-loose">
              All of Gold
